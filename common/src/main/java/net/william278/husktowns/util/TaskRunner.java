...
public interface TaskRunner {
     ...
     * @return The ID of the synchronous task
     */
    int runSync(String world, int chunkX, int chunkZ, @NotNull Runnable runnable);

    /**
     * Run a task synchronously on the server thread continuously for a period
     *
     * @param runnable The task to run
     ...
     * @return The ID of the async task
     */
    int runTimedSync(@NotNull Runnable runnable, long delay, long period);
    /**
     * Run a task synchronously on the server thread continuously for a period
     *
     * @param runnable The task to run
     ...
     * @return The ID of the async task
     */
    int runTimedSync(String world, int chunkX, int chunkZ, @NotNull Runnable runnable, long delay, long period);
