...
public class ExplosionDamageFlag extends Flag {
    ...
    public ExplosionDamageFlag(boolean allowed) {
        super(FLAG_IDENTIFIER, "Explosion Damage", "Allows explosions from blocks and monsters to destroy terrain", allowed, EventListener.ActionType.BLOCK_EXPLOSION_DAMAGE, EventListener.ActionType.MOB_EXPLOSION_DAMAGE);
    }
}